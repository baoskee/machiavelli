...
validate.custom = function (field, data) {
  if (!field || !field.validateThrow)
    return ;

  /* iterates over validator functions */
  field.validateThrow.forEach(function (func) {
    if (!func(data))
...
Schema.prototype.validateThrow = function (data, cb) {
  try {
...
Schema.Field = require('./util/field');
Schema.Validator = require('./util/validator');
